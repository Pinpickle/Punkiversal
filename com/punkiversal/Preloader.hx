...
@:bitmap("assets/graphics/preloader/punkiversal.png")
class PunkiversalLogo extends BitmapData {}
	...
	public function new()
	{
		tileData = [
			...
			187, 260, 2, 1,  0, // factory
			  0, 260, 1, 1,  0, // punkiversal
		];

		tiles = new Tilesheet(new PunkiversalLogo(0, 0));
		tiles.addTileRect(new Rectangle(0, 0, 274, 58)); // powered by
		tiles.addTileRect(new Rectangle(0, 65, 274, 80)); // punkiversal
